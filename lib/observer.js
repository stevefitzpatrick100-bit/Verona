...
**Studio is home.** It is where the work lives — portrait sharpening, preferences becoming specific, the picture getting clear enough to match. Every other room exists in service of it. When uncertain, the answer is studio.

**Therapy is a medicinal detour, not a destination.** Set room_mismatch to "studio" when ANY of these are true on this turn:
...
- agency has been falling for 2+ readings, or dependency_risk ≥ 5

**Confessional is one moment, not a room.** After a confessional turn, the next move is almost always studio (sometimes lounge). It must NOT exit back to therapy — if you see that loop forming, set room_mismatch to "studio".
