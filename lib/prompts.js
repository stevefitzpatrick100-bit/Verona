...
{
  "dimensions": { "dimension_name": { "stated": 1-10, "revealed": 1-10, "grouping": "grouping_name", "weight": 1-10, "evidence": "brief note", "confidence": 1-5 } },
  "partner_image": { "dimension_name": { "stated": 1-10, "revealed": 1-10, "grouping": "grouping_name", "weight": 1-10, "flexibility": "rigid|moderate|flexible", "evidence": "brief note", "confidence": 1-5 } },
  "relationship_image": { "dimension_name": { "stated": 1-10, "revealed": 1-10, "grouping": "grouping_name", "weight": 1-10, "flexibility": "rigid|moderate|flexible", "evidence": "brief note", "confidence": 1-5 } },
  "memory": {
...
The three images share the same shape:
- Portrait (who they are): stated = their words about self; revealed = what stories/energy show.
- Partner image (what they want in a partner): stated = what they say they want; revealed = what you infer from portrait.
- Relationship image (the shape of life they want): stated = what they imagine; revealed = what their history actually evidences.

Numeric scales 1–10. Use null when you genuinely cannot read a layer.
